...
text = customtkinter.CTkLabel(master=app,text="Bienvenue sur notre chatbot d'orientation! Pour commencer, \nveuillez répondre aux questions suivantes pour nous \naider à mieux comprendre vos intérêts, vos compétences \net vos motivations. Nous utiliserons ces informations \npour vous suggérer des options de carrière qui correspondent \nà votre personnalité. Nous vous remercions d'avance pour votre participation !\n\n\n\n\nEnter your name:",font=("Verdana",25))
text.place(relx=0.5,rely=0.4,anchor=tkinter.CENTER)

entry = customtkinter.CTkEntry(master=app,height=60,width=400,font=("Arial",30))
